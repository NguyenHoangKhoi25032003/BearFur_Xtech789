  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderProducts(products) {
        ...
        if (products.length === 0) {
            productList.innerHTML = '<p class="text-center text-muted">Chưa có sản phẩm</p>';
            return;
        }
           ...
           col.innerHTML = `
                <div class="card_product h-100 position-relative">
                    ...
                    <div class="product-info">
                        ...
                        <p class="price">${formatPrice(product.price)} <span class="original-price">${originalPrice}</span></p>
